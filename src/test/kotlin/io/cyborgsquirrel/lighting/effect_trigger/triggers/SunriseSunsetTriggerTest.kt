...
import io.cyborgsquirrel.lighting.effects.service.LightEffectRegistryImpl
...
class SunriseSunsetTriggerTest(
    ...
    beforeTest {
        ...
        val effect = SpectrumLightEffect(60, SpectrumEffectSettings(), null, mockTimeHelper)
        activeEffect = ActiveLightEffect(
            UUID.randomUUID().toString(),
            1,
            true,
            LightEffectStatus.Inactive,
            effect,
            listOf(),
            mockStrip
        )
    ...
    @MockBean(LightEffectRegistryImpl::class)
    fun activeEffectRepository(): LightEffectRegistry = mockk()
}